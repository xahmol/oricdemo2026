...
18. [AY-3-8912 voice-sample playback (voice.h, tools/oric_voiceconv.py)](voice.md)
19. [Floppy-disk build target (tools/oric_floppybuilder.py, floppy.h)](floppy.md)
20. [Build notes](build-notes.md)
21. [Architecture — memory maps, section sequencer, subsystem design](architecture.md)
