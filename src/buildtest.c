...
// verifies PT3 decode correctness against two synthetic fixtures. Exercised
// by `make test` (see tests/scripts/test_boot.sh) -- not demo content.
//
// Moved out of src/main.c so main.c could become the real (HIRES-runtime)
// demo entry point without losing this regression coverage.
